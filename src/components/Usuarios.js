...
import { createTipoEquipo, getTipoEquipos, editarTipoEquipo } from '../services/Usuarios'
import Modal from './ui/Modal'
import ModalEdit from './ui/ModalEdit'

export default function Usuarios() {
const title= 'Tipo de Equipo'
const [tipoEquipos, setTipoEquipos] = useState(null)
        ...
        <div className='table-responsive'>
          {
            ...
            (
              ...
              <tbody>
                {
                  tipoEquipos != null ? tipoEquipos.map(( tipoEquipo, index) => {
                    return (
